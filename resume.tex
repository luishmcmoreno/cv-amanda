...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{}{Amanda Almeida Chagas}
\address{Rua Nhanduti 48, Alto-Caiçara, Belo Horizonte - MG}
\mobile{(+55) 31-9 8871-3058} 
%%% Social

\email{amandaalmeidachagas@gmail.com}
\facebook{mandyceleja}{Amanda Chagas}
\instagram{mandychagas}
%%% Optionals
